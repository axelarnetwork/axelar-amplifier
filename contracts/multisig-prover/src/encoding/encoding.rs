...
impl CommandBatchBuilder {
    pub fn new(destination_chain_id: Uint256, encoding_scheme: EncodingScheme) -> Self {
        Self {
            message_ids: vec![],
            new_worker_set: None,
            commands: vec![],
