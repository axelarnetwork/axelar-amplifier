...
fn route_from_router_with_destination_chain_not_matching_contract_fails() {
    ...
    let msg_with_wrong_destination = Message {
        destination_chain: chain_name!("wrong-chain"),
        ..msg
    };
...
fn route_from_router_to_nexus_succeeds() {
    ...
    let msgs = vec![
        Message {
            destination_chain: chain_name!("legacy-chain-1"),
            ..msg.clone()
        },
        Message {
            destination_chain: chain_name!("legacy-chain-2"),
            ..msg.clone()
        },
        Message {
            destination_chain: chain_name!("legacy-chain-2"),
...
fn route_to_router_after_contract_call_with_tempered_data_fails() {
    ...
    msgs[0].destination_chain = chain_name!("wrong-chain");
