...
use crate::msg::{AllItsAddressesResponse, ItsAddressResponse, TokenBalanceResponse};
...
mod tests {
    ...
    use super::*;
    use crate::state::{save_its_address, start_token_balance, update_token_balance};
