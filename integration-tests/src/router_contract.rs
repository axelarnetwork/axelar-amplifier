...
impl RouterContract {
    pub fn instantiate_contract(
        ...
        let code: ContractWrapper<router_api::msg::ExecuteMsg, router::msg::InstantiateMsg, router::msg::QueryMsg, _, _, _, _> = ContractWrapper::new_with_empty(execute, instantiate, query);
