...
use event_verifier_api::{EventData, EventToVerify, EvmEvent};
use events::try_from;
...
mod tests {
    ...
    use event_verifier_api::evm::Event as ApiEvent;
    use event_verifier_api::{
        EventData, EventToVerify, EvmEvent as ApiEvmEvent, TransactionDetails,
    };
