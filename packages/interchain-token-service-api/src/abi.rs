...
mod tests {
    ...
    fn interchain_transfer_encode_decode() {
        ...
        let cases = vec![
            (ITSRoutedMessage{
                ...
                }}, ""),
            (ITSRoutedMessage {
                remote_chain: remote_chain.clone(),
                message: ITSMessage::InterchainTransfer {
                    token_id: TokenId::new([255u8; 32]),
                    source_address: HexBinary::from_hex("4F4495243837681061C4743b74B3eEdf548D56A5").unwrap(),
                    destination_address: HexBinary::from_hex("4F4495243837681061C4743b74B3eEdf548D56A5").unwrap(),
                    amount: Uint256::MAX,
        ...
        for (original, encoded_original) in cases {
            let encoded = original.abi_encode();
            assert_eq!(HexBinary::from_hex(encoded_original).unwrap(), encoded);
    ...
    fn deploy_interchain_token_encode_decode() {
        ...
        let cases = vec![
            ...
            }, ""),
        ];
    ...
    fn deploy_token_manager_encode_decode() {
        ...
        let cases = vec![
            (ITSRoutedMessage{
                ...
                }}, ""),
            (ITSRoutedMessage {
                remote_chain: remote_chain.clone(),
                message: ITSMessage::DeployTokenManager {
                    token_id: TokenId::new([1u8; 32]),
